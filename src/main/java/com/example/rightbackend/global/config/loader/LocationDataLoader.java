...
public class LocationDataLoader {
    ...
    public void loadLocationData() {
        List<String> locationNames = Arrays.asList(
            ...
            "부산광역시 동래구", "부산광역시 남구", "부산광역시 북구", "부산광역시 강서구", "부산광역시 해운대구",
            "부산광역시 사하구", "부산광역시 금정구", "부산광역시 연제구", "부산광역시 수영구", "부산광역시 사상구",
            "부산광역시 기장군", "인천광역시 중구", "인천광역시 동구", "인천광역시 미추홀구", "인천광역시 연수구",
            "인천광역시 남동구", "인천광역시 부평구", "인천광역시 계양구", "인천광역시 서구", "인천광역시 강화군",
            "인천광역시 옹진군", "대구광역시 중구", "대구광역시 동구", "대구광역시 서구", "대구광역시 남구",
            ...
            "경기도 화성시", "강원특별자치도 원주시", "강원특별자치도 춘천시", "강원특별자치도 강릉시", "강원특별자치도 동해시",
            "강원특별자치도 속초시", "강원특별자치도 삼척시", "강원특별자치도 홍천군", "강원특별자치도 태백시", "강원특별자치도 철원군",
            "강원특별자치도 횡성군", "강원특별자치도 평창군", "강원특별자치도 영월군", "강원특별자치도 정선군", "강원특별자치도 인제군",
            "강원특별자치도 고성군", "강원특별자치도 양양군", "강원특별자치도 화천군", "강원특별자치도 양구군", "충청북도 청주시",
            ...
            "경상북도 울진군", "경상북도 울릉군", "경상남도 창원시", "경상남도 김해시", "경상남도 진주시",
            "경상남도 양산시", "경상남도 거제시", "경상남도 통영시", "경상남도 사천시", "경상남도 밀양시",
            "경상남도 함안군", "경상남도 거창군", "경상남도 창녕군", "경상남도 고성군", "경상남도 하동군",
            "경상남도 합천군", "경상남도 남해군", "경상남도 함양군", "경상남도 산청군", "경상남도 의령군",
            "전북특별자치도 전주시", "전북특별자치도 익산시", "전북특별자치도 군산시", "전북특별자치도 정읍시", "전북특별자치도 완주군",
            "전북특별자치도 김제시", "전북특별자치도 남원시", "전북특별자치도 고창군", "전북특별자치도 부안군", "전북특별자치도 임실군",
            "전북특별자치도 순창군", "전북특별자치도 진안군", "전북특별자치도 장수군", "전북특별자치도 무주군", "전라남도 여수시",
            "전라남도 순천시", "전라남도 목포시", "전라남도 광양시", "전라남도 나주시", "전라남도 무안군",
            "전라남도 해남군", "전라남도 진도군", "전라남도 완도군", "전라남도 강진군", "전라남도 장흥군",
            "전라남도 보성군", "전라남도 고흥군", "전라남도 영광군", "전라남도 함평군", "전라남도 담양군",
            "전라남도 곡성군", "전라남도 구례군", "전라남도 신안군"
        );
        
        for (String name : locationNames) {
            Optional<Location> existingLocation = locationRepository.findByName(name);
            if (existingLocation.isEmpty()) {
                Location location = Location.of(name);
